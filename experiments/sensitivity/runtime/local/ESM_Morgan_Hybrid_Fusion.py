...
ESM_WINDOW_LAYOUTS = ("legacy_anchors_v1", "even_span_v2")
DEFAULT_ESM_WINDOW_LAYOUT = "legacy_anchors_v1"
...
def _esm_cache_path_for_window(
    ...
    layout_suffix = (
        "" if window_layout == DEFAULT_ESM_WINDOW_LAYOUT else f"__wl{window_layout}"
    )
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help='ESM2 depth-window placement strategy; use legacy_anchors_v1 for v4',
    )
...
def run_fixed_split(args, device, total_start):
    ...
    with open(metrics_file, 'w') as f:
        ...
        layout_suffix = (
            "" if args.window_layout == DEFAULT_ESM_WINDOW_LAYOUT
