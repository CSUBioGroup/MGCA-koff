...
class MolFormerEmbedder:
    def __init__(self, device='cuda'):
        ...
        self.model = AutoModel.from_pretrained("seyonec/PubChem10M_SMILES_BPE_450k", use_safetensors=False)
...
def main():
    ...
    if args.data_csv:
        ...
        all_df = normalize_input_columns(pd.read_csv(args.data_csv), args.data_csv)
